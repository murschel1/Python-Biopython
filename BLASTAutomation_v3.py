...
######################################################################################################################
### PUT THE NAME OF YOUR FASTA FILE CONTAINING SEQUENCES TO BE BLASTED IN PLACE OF THE TEXT IN QUOTES IN NEXT LINE ###
######################################################################################################################
fasta_string = open("C:\PostDoc\Geomicro_server\BioPythonScripts\BLASTAutomation\FASTA_sequences_input.txt").read()

##########################################################################################################################################################
### PUT THE NAME OF THE BLAST ALGORITHM YOU WANT TO USE IN THE FIRST SET OF QUOTES, AND THE DATABASE YOU WANT IN THE SECOND SET OF QUOTES IN NEXT LINE ###
##########################################################################################################################################################
result_handle = NCBIWWW.qblast("blastn", "nt", fasta_string,hitlist_size=1000)
...
###################################################################
### REPLACE TEXT IN QUOTES IN NEXT LINE WITH YOUR EMAIL ADDRESS ###
###################################################################
Entrez.email = "urschm@rpi.edu"

#Open BLAST log file (tab-delimited text file)
############################################################################################
### REPLACE TEXT IN FIRST SET OF QUOTES BELOW WITH YOUR DESIRED RESULTS OUTPUT FILE NAME ###
############################################################################################
