...
result_handle = NCBIWWW.qblast("blastp", "nr", fasta_string, hitlist_size=5)
...
for blast_record in blast_records:
    for alignment in blast_record.alignments:
        for hsp in alignment.hsps:
            ...
            BLASTLogString = BLASTLogString+str(blast_record.query)+"\t"
            ...
            BLASTLogString = BLASTLogString+str(hsp.query[0:75] + dots)+"\t"
            ...
            BLASTLogString = BLASTLogString+str(hsp.sbjct[0:75] + dots)+"\t"
